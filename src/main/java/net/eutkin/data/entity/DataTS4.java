...
@Entity
@Table(name = "data_ts4")
public class DataTS4 extends AbstractDataTS {
    @Id
    @Column(name = "ts_id")
    @SequenceGenerator(name = "data_ts4_seq", sequenceName = "data_ts4_seq",allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "data_ts4_seq")
    @NotNull
