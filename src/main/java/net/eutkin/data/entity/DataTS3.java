...
@Entity
@Table(name = "data_ts3")
public class DataTS3 extends AbstractDataTS {
    @Id
    @Column(name = "ts_id")
    @SequenceGenerator(name = "data_ts3_seq", sequenceName = "data_ts3_seq",allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "data_ts3_seq")
    @NotNull
