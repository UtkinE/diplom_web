...
@Entity
@Table(name = "data_ts5")
public class DataTS5 extends AbstractDataTS {
    @Id
    @Column(name = "ts_id")
    @SequenceGenerator(name = "data_ts5_seq", sequenceName = "data_ts5_seq",allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "data_ts5_seq")
    @NotNull
