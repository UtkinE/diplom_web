...
@Entity
@Table(name = "data_ts6")
public class DataTS6 extends AbstractDataTS {
    @Id
    @Column(name = "ts_id")
    @SequenceGenerator(name = "data_ts6_seq", sequenceName = "data_ts6_seq",allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "data_ts6_seq")
    @NotNull
